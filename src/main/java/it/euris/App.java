...
import it.euris.service.ExecutionServiceImpl;
...
public class App 
{
    public static void main( String[] args ) throws DistanceConverterException {
        ...
        System.out.println(String.format("ad una velocita' media di %s per percorrere %s ci vogliono:", velocita, distanza));
        System.out.println(tpcService.execute(new ExecutionServiceImpl()));
    }
}
