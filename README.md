...
data una distanza e una velocità (in qualsiasi unità di misura) 
definire il tempo necessario per percorrere quella distanza (definito in ore, minuti, secondi).
